...
np.random.seed(2)
w1 = np.random.rand(n_h,n_x)   # Weight matrix for hidden layer (x to hidAden)
...
```
 ## OUTPUT 
![image](https://github.com/Nivetham1710/Experiment-3-Implementation-of-MLP-for-non-linear-separable-problem/assets/94155183/4e5c60fd-8db5-4155-9fb9-13155c1e514c)

![image](https://github.com/Nivetham1710/Experiment-3-Implementation-of-MLP-for-non-linear-separable-problem/assets/94155183/a217bd07-94e2-456d-a825-365a523bc454)

## RESULT

Thus program for MLP has been successfully implemented for non linear separable problem using Python.
